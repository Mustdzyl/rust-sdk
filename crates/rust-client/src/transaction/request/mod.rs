...
pub struct TransactionRequest {
    ...
    /// Pinned consumption modes set through
...
impl TransactionRequest {
    ...
    /// `authenticated_note_records` holds a record for it and unauthenticated otherwise. The
    /// result keeps the order of the request.
